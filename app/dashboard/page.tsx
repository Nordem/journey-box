            ...
            <div className="flex flex-col gap-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-indigo-300">Welcome back, {userData?.userProfile?.name || user?.email}</p>
                </div>
                <div className="flex space-x-2">
                  <Button 
                    ...
                    disabled={refreshing}
                    className="flex items-center border-indigo-500/30 bg-indigo-950/50 hover:bg-indigo-800/30 text-indigo-100"
                  >
                  ...
                  <Button 
                    ...
                    className="border-indigo-500/30 bg-indigo-950/50 hover:bg-indigo-800/30 text-indigo-100"
                  >
              ...
              {!userData ? (
                <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                  <CardHeader>
                    <CardTitle className="text-white">Profile Not Found</CardTitle>
                    <CardDescription className="text-indigo-300">We couldn't find your profile in our database</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Tabs defaultValue="profile" className="w-full">
                  <TabsList className="mb-6 bg-transparent border border-indigo-500/30 rounded-xl overflow-hidden">
                    <TabsTrigger 
                      value="profile"
                      className="py-3 data-[state=active]:bg-gradient-to-r data-[state=active]:from-indigo-600/80 data-[state=active]:to-purple-600/80 data-[state=active]:text-white data-[state=active]:shadow-none rounded-none text-indigo-300"
                    >
                  ...
                  <TabsContent value="profile" className="space-y-6">
                    <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                      <CardHeader>
                        ...
                        <CardDescription className="text-indigo-300">Your basic profile information</CardDescription>
                      </CardHeader>
                      <CardContent>
                            ...
                            <div className="flex flex-wrap gap-2 mt-1">
                              {userData.userProfile.languages?.length > 0 ? 
                                userData.userProfile.languages.map((lang: string, i: number) => (
                                  <span key={i} className="bg-purple-800 text-purple-100 px-2 py-1 rounded-md text-sm">
                                    {lang}
                                  </span>
                                )) : 
                                <p>None specified</p>
                    ...
                    {(userData.userProfile.personalityTraits?.length > 0 || 
                      ...
                      <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                        <CardHeader>
                          <CardTitle className="text-white">Personality & Interests</CardTitle>
                          <CardDescription className="text-indigo-300">Your traits, interests and objectives</CardDescription>
                        </CardHeader>
                        <CardContent>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {userData.userProfile.personalityTraits?.length > 0 && (
                              <div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-1">
                                  {userData.userProfile.personalityTraits.map((trait: string, i: number) => (
                                    <span key={i} className="bg-pink-800 text-pink-100 px-2 py-1 rounded-md text-sm">
                                      {trait}
                                    </span>
                                  ))}
                                </div>
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-1">
                                  {userData.userProfile.hobbiesAndInterests.map((interest: string, i: number) => (
                                    <span key={i} className="bg-blue-800 text-blue-100 px-2 py-1 rounded-md text-sm">
                                      {interest}
                                    </span>
                                  ))}
                                </div>
                  ...
                  <TabsContent value="recommendations" className="space-y-6">
                    <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                      <CardHeader>
                        <CardTitle className="text-white">Recommended Events</CardTitle>
                        <CardDescription className="text-indigo-300">Events matched to your preferences and profile</CardDescription>
                      </CardHeader>
                      <CardContent>
                    ...
                    <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                      <CardHeader>
                        ...
                        <CardDescription className="text-indigo-300">Browse all available events</CardDescription>
                      </CardHeader>
                      <CardContent>
                        {loadingAllEvents ? (
                          <div className="space-y-4">
                  ...
                  <TabsContent value="preferences" className="space-y-6">
                    <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                      <CardHeader>
                        ...
                        <CardDescription className="text-indigo-300">Your preferences and restrictions</CardDescription>
                      </CardHeader>
                      <CardContent>
                        {userData?.eventPreferences ? (
                          <>
                            ...
                            {(userData.eventPreferences.preferredExperiences?.length > 0 || 
                              ...
                              <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                                <CardHeader>
                                  ...
                                  <CardDescription className="text-indigo-300">Your experiences and destinations preferences</CardDescription>
                                </CardHeader>
                                <CardContent>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {userData.eventPreferences.preferredExperiences?.length > 0 && (
                            ...
                            {(userData.eventPreferences.teamBuildingPrefs?.preferredActivities?.length > 0 || 
                              ...
                              <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                                <CardHeader>
                                  <CardTitle className="text-white">Team Building Preferences</CardTitle>
                                  <CardDescription className="text-indigo-300">Your team building preferences</CardDescription>
                                </CardHeader>
                                <CardContent>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {userData.eventPreferences.teamBuildingPrefs?.preferredActivities?.length > 0 && (
                            ...
                            {(userData.eventPreferences.seasonalPreferences?.length > 0 || 
                              ...
                              <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                                <CardHeader>
                                  <CardTitle className="text-white">Seasonal & Availability Preferences</CardTitle>
                                  <CardDescription className="text-indigo-300">Your time and seasonal preferences</CardDescription>
                                </CardHeader>
                                <CardContent>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {userData.eventPreferences.seasonalPreferences?.length > 0 && (
                            ...
                            {(userData.eventPreferences.categories?.length > 0 || 
                              ...
                              <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                                <CardHeader>
                                  <CardTitle className="text-white">Event Category Preferences</CardTitle>
                                  <CardDescription className="text-indigo-300">Your preferred categories and vibes</CardDescription>
                                </CardHeader>
                                <CardContent>
                                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {userData.eventPreferences.categories?.length > 0 && (
                            ...
                            {userData?.restrictions && 
                              ...
                              <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                                <CardHeader>
                                  <CardTitle className="text-white">Restrictions</CardTitle>
                                  <CardDescription className="text-indigo-300">Your event restrictions</CardDescription>
                                </CardHeader>
                                <CardContent>
                            ...
                            {!(userData.eventPreferences.preferredExperiences?.length > 0 || 
                              ...
                              <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                                <CardHeader>
                                  <CardTitle className="text-white">No Preferences Set</CardTitle>
                                  <CardDescription className="text-indigo-300">You haven't set any preferences yet</CardDescription>
                                </CardHeader>
                                <CardContent>
                          ...
                          <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                            <CardHeader>
                              <CardTitle className="text-white">Preferences Not Available</CardTitle>
                              <CardDescription className="text-indigo-300">Your preference information is not available</CardDescription>
                            </CardHeader>
                            <CardContent>
                  ...
                  <TabsContent value="calendar" className="space-y-6">
                    <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                      <CardHeader>
                        ...
                        <CardDescription className="text-indigo-300">Your scheduled events</CardDescription>
                      </CardHeader>
                      <CardContent>
                  ...
                  <TabsContent value="deliverables" className="space-y-6">
                    <Card className="bg-indigo-950/30 border-indigo-500/30 text-white">
                      <CardHeader>
                        ...
                        <CardDescription className="text-indigo-300">Your goals and commitments</CardDescription>
                      </CardHeader>
                      <CardContent>
